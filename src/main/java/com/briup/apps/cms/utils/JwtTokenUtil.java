...
public class JwtTokenUtil {
    ...
    private static final int expiresSecond = 3600000;
    /**
     * 解析jwt
     * @param jsonWebToken
     ...
     * @return
     */
    public static String createJWT(Integer integer, String username) {
        try {
            // 使用HS256加密算法
            ...
            //userId是重要信息，进行加密下
            String encryId = Base64Util.encode(integer.toString());
